...
(function (root, factory) {
  ...
  var DICT = {
    ...
    'update.notif':   { ja: '新しいバージョン v{latest} が利用できます。クリックでダウンロードページを開きます。', en: 'Version v{latest} is available. Click to open the download page.', zhHans: '有新版本 v{latest} 可用。点击打开下载页面。', zhHant: '有新版本 v{latest} 可用。點擊開啟下載頁面。', ko: '새 버전 v{latest}을(를) 사용할 수 있습니다. 클릭하면 다운로드 페이지가 열립니다.' },
  };
