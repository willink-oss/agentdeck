...
(function (root, factory) {
  ...
  function classifyLine(line) {
    ...
    // Only a genuine git "---/+++" header (target "a/…","b/…" or /dev/null) is a file
    // line; a body line whose content merely starts with "-- "/"++ " (e.g. the "-- "
    // signature delimiter renders as "--- ") must fall through to del/add, not a header.
    if (/^(--- |\+\+\+ )([a-z]\/|\/dev\/null)/.test(line)) return 'dl dl-file';
